...
class TestDeleteDir:
    ...
    def test_delete_existing_good_dir_with_a_child_with_recursion(self, tmp_path, good_dir):
        ...
        FileService().delete_dir(target_dir, recursive=True)
